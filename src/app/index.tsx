...
// 1. Definição do tipo para o objeto de resultado
type ResultadoType = {
  gorjeta: string;
  total: string;
  porPessoa: string;
...
export default function App() {
  // 2. Tipagem explícita nos hooks de estado
  ...
  const calcular = () => {
    ...
    if (isNaN(valorConta) || isNaN(percentual) || isNaN(pessoas) || pessoas <= 0) {
    ...
    // Agora o TypeScript aceita este objeto pois ele respeita o ResultadoType
    setResultado({
        ...
        {resultado && (
          <View style={styles.resultCard}>
            ...
            <View style={styles.resultRow}>
              ...
              <Text style={styles.resultValueHighlight}>R$ {resultado.porPessoa}</Text>
            </View>
          </View>
        )}
